...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 10:38:35 2021
...
class poverty():
    def __init__(self):
        ...
        self.table['>poverty'] = self.table[['1.85 to 1.99', '1.00 to 1.24', 
               '1.50 to 1.84','1.25 to 1.49']].apply(np.sum, axis = 1)
        self.table['<poverty'] = self.table[['Under .50', '.50 to .99']].apply(np.sum, axis = 1)
        self.table = self.table[self.table.columns.to_list()[:4]+ ['>2x_poverty', '>poverty','<poverty' ]+ ['total']]
